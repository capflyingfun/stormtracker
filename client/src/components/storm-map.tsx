      ...
      const waypointIcon = window.L.divIcon({
        html: `
          <div style="
            ...
            transform: rotate(${movementDirection + 180}deg);
          ...
          <style>
            @keyframes specialStormPulse {
              0% { transform: rotate(${movementDirection + 180}deg) scale(1); opacity: 1; }
              50% { transform: rotate(${movementDirection + 180}deg) scale(1.15); opacity: 0.8; }
              100% { transform: rotate(${movementDirection + 180}deg) scale(1); opacity: 1; }
            }
