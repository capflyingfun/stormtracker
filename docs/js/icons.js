...
const _ICON_PACK_FILES={
  ...
  globe:['clear-day','clear-night','partly-cloudy-day','partly-cloudy-night','partly-cloudy-day-snow','overcast','overcast-dark','cloud-light','cloud-small','few-clouds-day-rain','few-clouds-day-snow','rain','rain-heavy','mostly-cloudy-day-rain','mostly-cloudy-day-rain-heavy','mostly-cloudy-night','mostly-cloudy-night-rain','mostly-cloudy-night-rain-heavy','mostly-cloudy-night-snow','thunderstorm','thunderstorm-rain','thunderstorm-lightning','thunderstorm-night','snow','snow-night','blizzard','fog','haze','tornado','wind','wind-chill'],
  'globe-animated':['clear-day','clear-night','partly-cloudy-day','partly-cloudy-night','partly-cloudy-day-snow','overcast','overcast-dark','cloud-light','cloud-small','few-clouds-day-rain','few-clouds-day-snow','rain','rain-heavy','mostly-cloudy-day-rain','mostly-cloudy-day-rain-heavy','mostly-cloudy-night','mostly-cloudy-night-rain','mostly-cloudy-night-rain-heavy','mostly-cloudy-night-snow','thunderstorm','thunderstorm-rain','thunderstorm-lightning','thunderstorm-night','snow','snow-night','blizzard','fog','haze','tornado','wind','wind-chill','hurricane','heat','ice','dust-storm','fire','flood','air-quality','avalanche','rip-current','small-craft','special-weather','storm-surge','tsunami']
};
const _WMO_TO_COND={};
...
function wmoDesc(code,isDay){const m={0:isDay===false?'Clear':'Sunny',1:isDay===false?'Mostly Clear':'Mostly Sunny',2:'Partly Cloudy',3:'Overcast',45:'Fog',48:'Rime Fog',51:'Light Drizzle',53:'Moderate Drizzle',55:'Dense Drizzle',56:'Freezing Drizzle',57:'Dense Freezing Drizzle',61:'Slight Rain',63:'Moderate Rain',65:'Heavy Rain',66:'Freezing Rain',67:'Heavy Freezing Rain',71:'Slight Snow',73:'Moderate Snow',75:'Heavy Snow',77:'Snow Grains',80:'Rain Showers',81:'Mod Rain Showers',82:'Violent Rain Showers',85:'Snow Showers',86:'Heavy Snow Showers',95:'Thunderstorm',96:'T-storm w/ Hail',99:'T-storm w/ Heavy Hail'};return m[code]||'Unknown'}
function cloudCategory(pct){if(pct>=90)return'Overcast';if(pct>=70)return'Mostly Cloudy';if(pct>=30)return'Partly Cloudy';if(pct>10)return'Mostly Clear';return'Clear'}