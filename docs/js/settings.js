...
const CHANGELOG=[
  {ver:'v3.47',date:'2026-03-29',items:['🖥️ Desktop Single-Page Mode — all 5 sections on one scrollable page. Sidebar scrolls to sections.','📡 Radar map fills nearly full viewport height on desktop.','🔄 Scroll spy highlights active section in sidebar.','🔧 Sonar keep-alive on desktop.','🐛 Fixed ticker speed description (was backwards).','💨 Larger wind gauge on desktop (480px).']},
