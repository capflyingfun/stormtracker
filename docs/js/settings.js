...
const CHANGELOG=[
  {ver:'v3.45',date:'2026-03-29',items:['🖥️ Desktop Stacked Layout — all 5 tabs now stack sections vertically like mobile (was: 2-column grid splitting things side-by-side). Full-width single column for better readability.','📡 Radar Map Full-Screen — radar map now fills nearly the entire viewport height on desktop (~1400px max), up from 480px.']},
