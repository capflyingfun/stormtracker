...
const CHANGELOG=[
  {ver:'v3.46',date:'2026-03-29',items:['🖥️ Desktop Single-Page Mode — all 5 sections display on one scrollable page on desktop. Sidebar nav links scroll to each section instead of switching tabs. Radar map, sonar, and all content stay live and visible.','📡 Radar Map Full-Screen — radar map now fills nearly the entire viewport height on desktop (~1400px max), up from 480px.','🔄 Scroll Spy — sidebar highlights the current section as you scroll through the page.','🔧 Sonar keep-alive — sonar auto-restarts if animation stops on desktop.']},
