...
- **Pulsating Border Alerts**: Storm cells with alerts now feature pulsating colored borders that match the alert intensity level for clear visual indication